...
- 关注细节，追求卓越
    - 细节不一定决定成败但却可以充分体现一个人的工作态度，请做一个靠谱的队友。
    - 认真对待各种流程、规范，比如写英文邮件时，从语法、格式到每一个拼写、标点，再比如 Commit Message 的格式、Coding Style 等等。
    - 代码仅仅是可以工作是不够的，还要可读、易扩展、可维护、安全、高效，等等等等，写代码要“上心”，不要敷衍、随意。
