...
- 多人参与的事务，最好在公开渠道沟通，比如邮件、issue 或 IM 群组等，该开会的时候开会，避免跟多个人私聊同一件事情而反复交代上下文，尽量保证沟通透明、信息对称。通常来说，只有涉及敏感信息、明确需要把某些人排除在外、确实与其他人无关的时候，才私聊。不要担心会打扰不相关的人，因为如果这个人不相关，TA 要么不要关注这个 issue ，要么离开这个 IM 群组，要么设置自己的通知级别为“仅提到”，总之是这个人自己的事情。注意 IM 群组的主题，必要的话创建专门的新群组。
- 在邮件或 issue 上对某人发起提问后，不要再跑到 IM 上去提醒，尤其不要在公共 IM 群组提醒，这种提醒是纯粹的噪音。对方不看、不回怎么办？如果你有期望回复的最晚时间，那么直接写明，否则对方可能确实在忙，把你的往后排了；如果对方经常不回，不管有没有指明期望回复时间，那么是这个人的问题，看邮件、回邮件是基本的职业素养，提醒 TA 注意处理邮件，但是绝对不要容忍每次都要提醒，绝对不要默许这种费劲的沟通方式，这种人是在浪费大家的时间，甚至可能带坏其他人。
- 尽量不要使用微信沟通，原因：历史记录只保存在客户端，易丢失，不易搜索，新成员看不到历史消息；PC 端只能登陆一个设备，家里公司要频繁切换登录，还必须在手机上确认（WTF？）；功能有限，不支持机器人，不能高亮代码。推荐使用 https://bearychat.com/ 或自行搭建 https://rocket.chat/ 。
